...
public class ListAdapterMenuMakanan extends RecyclerView.Adapter<ListAdapterMenuMakanan.myViewHolder> {

    ArrayList<modelPenjualan> arrayList;
    Context context;

    public ListAdapterMenuMakanan(ArrayList<modelPenjualan> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public ListAdapterMenuMakanan.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater=LayoutInflater.from(context);
        View view=inflater.inflate(R.layout.format_menu_makanan,parent,false);
        return new ListAdapterMenuMakanan.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListAdapterMenuMakanan.myViewHolder holder, @SuppressLint("RecyclerView") int position) {
