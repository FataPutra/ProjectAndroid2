...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        password = findViewById(R.id.passwordregist);
        confpassword = findViewById(R.id.konfpasswordregist);
        register = findViewById(R.id.tmblregist);
        login = findViewById(R.id.tmblloginregist);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (sPassword.equals(sConfPassword) && !sPassword.equals("")){
                    modelUser.setUsername(sUsername);
                    modelUser.setEmail(sEmail);
                    modelUser.setPassword(sPassword);
                    dbr.push().setValue(modelUser);
