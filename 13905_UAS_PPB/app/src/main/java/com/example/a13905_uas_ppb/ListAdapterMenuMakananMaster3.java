...
public class ListAdapterMenuMakananMaster3 extends RecyclerView.Adapter<ListAdapterMenuMakananMaster3.myViewHolder> {
    ArrayList<ModelMenuMakanan2> arrayList;
    Context context;

    public ListAdapterMenuMakananMaster3(ArrayList<ModelMenuMakanan2> arrayList, Context context) {
    ...
    @NonNull
    @Override
    public ListAdapterMenuMakananMaster3.myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.format_menu_master, parent, false);
        return new ListAdapterMenuMakananMaster3.myViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListAdapterMenuMakananMaster3.myViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.Relatiview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("keybarang", arrayList.get(position).key);
